...
private Class<T> aClass;
	...
	/**S� sendo permitido acesso a esse metodo as classes
	 * que estenderem esse metodo.
	 * 
	 * 
	 * @return EntityManager- instancia do JPAUtil Testando com o .getInstance() se j� existe, e um EntityManager. 
	 */
	...
	public List<T> findAll(){
		...
		manager.getTransaction().commit(); // fixar a transa��o.
		manager.close(); //liberar o objeto da memoria
	...
	/**Consulta por Id para retornar um �nico objeto
	 * 
	 ...
	 * 
	 * @param entity - ser� recebido apartir do generico da classe.
	 */
	 ...
	 * 
	 * @param id - receberar o ID paara a conculta antes da dele��o
	 */
	public void delete(Long id){
		...
		//manager.remove(manager.find(aClass, id));  //Consulta pelo Id e depois a dele��o.
		//a Diferen�a do find � que ele busca todo o conteudo
		//e o getReference busca pela referencia do objeto pelo Id.
		manager.remove(manager.getReference(aClass, id));// assim � mais rapido
